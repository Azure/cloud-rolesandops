...
- Architecture decisions during the adoption phase need to be reviewed over time to keep up with evolving technology and business requirements. Evolving services that deliver better security, reliability and performance are examples that necessitate active operations.
